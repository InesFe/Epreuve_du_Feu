...
def faire_addition(calcul)
	...
	return résultat_addition
end

p faire_addition(calcul_initial)

def faire_soustraction(calcul)
	calcul_splité = calcul_splité = calcul.to_s.chars
	...
	return résultat_soustraction
end

p faire_soustraction(calcul_initial)
