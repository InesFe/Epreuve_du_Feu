...
sous_calcul = " "
	...
	if calcul_cut.include?("*") #faire les multiplications, divisions, modulos du calcul final
		...
		p calcul_cut.insert(calcul_cut.index("+")+1, "#{sous_calcul}".to_i) #renvoyer le résultat dans le calcul
		...
		p calcul_cut.insert(calcul_cut.index("+")+1, "#{sous_calcul}") #renvoyer le résultat dans le calcul
