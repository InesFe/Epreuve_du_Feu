...
def trouver_la_sortie(lab_matrice, coord_entrée, coord_sortie)
	...
	# Matrice de distance avec des valeurs à l'infini sauf pour l'entrée
	...
	while queue.length > 0 #retirer le prochain noeud de la file
    
    	noeud = queue.shift
    	voisins = [[-1, 0], [0, 1], [1, 0], [0, -1]]#Parcourir les noeuds des 4 voisins
  	...
  	#tracer le chemin dans la matrice
	chemin = []
  	compteur = 0
