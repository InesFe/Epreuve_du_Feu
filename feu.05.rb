...
# Initialisation de la matrice de distance avec des valeurs à l'infini sauf pour l'entrée
  ...
  while queue.length > 0
    # On retire le prochain noeud de la file
    noeud = queue.shift
    
    # On parcourt les noeuds adjacents
    voisins = [[-1, 0], [0, 1], [1, 0], [0, -1]] # les 4 voisins possibles
...
p coordonées_sortie
p trouver_la_sortie(laby_matrice, coordonées_entrée, coordonées_sortie)
